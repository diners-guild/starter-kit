...
const AboutPageContent = () => {
  return (
    <React.Fragment>
      ...
      >
        Drive to Change - How Diner’s Guild Started
      </Typography>
      <Typography
        variant="h5"
        component="div"
        ...
        style={{ margin: 16, textAlign: "center" }}
      >
        The idea for Diner’s Guild came from CEO and Founder, Bryan Jackson, who
      ...
      <Typography
        ...
        style={{ margin: 16, textAlign: "center" }}
      >
        “I’d love for them [businesses] to put out coupons to encourage
      ...
      <Typography
        ...
        style={{ margin: 16, textAlign: "center" }}
      >
        “And so, our thought is that by digitizing the experience and making the
      ...
      <Typography
        ...
        style={{ margin: 16, textAlign: "center" }}
      >
        Keeping track of paper coupons that you are meaning to use can be
      ...
      <Typography
        ...
        style={{ margin: 16, textAlign: "center" }}
      >
        With Bryan’s experience working with restaurants and businesses alike
